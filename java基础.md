...
4、用户操作界面、查询账户、退出账户，回到欢迎页

5、用户存款，用户取款

判断余额是否大于100，判断取款是否超过余额，限额

6、转账

判断：1、自己的账户是否有钱 2、输入对方账户卡号，判断是否存在，认证姓氏

7、销户

1、问用户是否确认销户，不确定，返回操作页面

2、若账户中还有钱，不能销户，回到操作页面
